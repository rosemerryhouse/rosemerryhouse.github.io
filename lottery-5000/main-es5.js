(function () {
  ...
  (self["webpackChunkangular"] = self["webpackChunkangular"] || []).push([["main"], {
        ...
        _createClass(LotteryComponent, [{
          ...
          value: function findWinner() {
            ...
            this.lotPersons.forEach(function (p) {
              ...
              // }
              var data = _this3.lotteryData.lotNumber;
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"inline-block w-auto px-3 bg-white text-red-500 font-bold rounded-md m-1 border-2 h-10 leading-10\">\n  {{ lotNo }}\n</div>\n";
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"inline-block rounded-2xl bg-blue-100 text-blue-800 px-3 py-1 mx-1\">\n  {{person.name}} <span class=\"text-xs text-gray-800 mx-1\">{{person.lastNum}}</span>\n</div>";
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"inline-block w-auto px-2 bg-yellow-100  font-bold text-orange-500  rounded-3xl m-1 border-2 border-yellow-200\">\n<i class=\"fas fa-award text-red-400\"></i>\n{{ winner.name }} \n<span class=\"text-sm text-gray-800 font-base \">({{winner.lastNum}}) </span>\n</div>";
      /***/
    },
